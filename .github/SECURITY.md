...
The Qualtran developers and community take security bugs in Qualtran seriously.
...
a Vulnerability"](https://github.com/quantumlib/qualtran/security/advisories/new)
interface from the _Security_ tab of the Qualtran repository.

Please report security issues in third-party modules to the person or team
maintaining the module rather than the Qualtran project stewards, unless you
believe that some action needs to be taken with Qualtran in order to guard
