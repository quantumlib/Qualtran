...
def test_cnot_assign_dict():
    ...
    out_vals, soq_assign = _cbloq_call_classically(cbloq.registers, in_data, cbloq._binst_graph)
    print(soq_assign)
...
def test_apply_classical_cbloq():
    ...
    xarr = 0
    ret = cbloq.on_classical_vals(x=xarr)
