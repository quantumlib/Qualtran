...
@pytest.mark.parametrize("n_qubits, rot_reg_size, state_coefs", [
  [1, 2, ((-0.5-0.5j), (0.5-0.5j))],
  [1, 4, ((-0.8154931568489165-0.16221167441072862j), (-0.46193976625564304-0.30865828381745486j))],
  [3, 3, ((-0.42677669529663675-0.1767766952966366j), (0.17677669529663664-0.4267766952966367j), (0.17677669529663675-0.1767766952966368j), (0.07322330470336305-0.07322330470336309j), (0.4267766952966366-0.17677669529663692j), (0.42677669529663664+0.17677669529663675j), (0.0732233047033631+0.17677669529663678j), (-0.07322330470336308-0.17677669529663678j))]
])
...
@pytest.mark.parametrize("n_qubits, rot_reg_size, state_coefs", [
  [1, 4, ((-0.8154931568489165-0.16221167441072862j), (-0.46193976625564304-0.30865828381745486j))],
  [2, 3, ((0.3535533905932734-0.35355339059327373j), (0.3535533905932735-0.3535533905932736j), (-0.4999999999999997+1.1102230246251563e-16j), (0.35355339059327356+0.35355339059327356j))],
])
...
@pytest.mark.parametrize("n_qubits, rot_reg_size, state_coefs", [
  [1, 3, ((0.481145088606368-0.47950088720913586j), (-0.41617865941997106-0.604461434931144j))],
  [2, 3, ((-0.45832126811131957-0.18416419776558368j), (0.17057042949351137+0.24581249575498615j), (-0.6048757470423172-0.5250403822076705j), (-0.13534197956156918-0.08153272490768977j))]
])
