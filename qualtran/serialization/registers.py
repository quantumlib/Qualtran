...
from qualtran.serialization.data_types import data_type_from_qdt_proto, data_type_to_qdt_proto
...
def register_to_proto(register: Register) -> registers_pb2.Register:
    return registers_pb2.Register(
        name=register.name,
        dtype=data_type_to_qdt_proto(register.dtype),
...
def register_from_proto(register: registers_pb2.Register) -> Register:
    return Register(
        name=register.name,
        dtype=data_type_from_qdt_proto(register.dtype),
