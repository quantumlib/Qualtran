...
from qualtran.bloq_algos.basic_gates import Rx, Ry, Rz


def _make_Rx():
    from qualtran.bloq_algos.basic_gates import Rx

    return Rx(angle=np.pi / 4.0)


def _make_Ry():
    from qualtran.bloq_algos.basic_gates import Ry

    return Ry(angle=np.pi / 4.0)


def _make_Rz():
    from qualtran.bloq_algos.basic_gates import Rz
