...
def _get_in_vals(
    binst: DanglingT | BloqInstance, reg: Register, soq_assign: dict[_Soquet, ClassicalValT]
) -> ClassicalValT:
...
def add_ints(
    a: ClassicalValT, b: ClassicalValT, *, num_bits: int | None = None, is_signed: bool = False
) -> ClassicalValT:
