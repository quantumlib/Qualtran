...
def _from_directly_countable_bloqs(bloq: Bloq) -> Optional[TComplexity]:
    ...
    from qualtran.bloqs.basic_gates import CHadamard, TGate
    ...
    if isinstance(bloq, CHadamard):
        # TODO https://github.com/quantumlib/Qualtran/issues/878
        #      https://github.com/quantumlib/Qualtran/issues/237
        #      Currently, CH costs are based on the historical cirq t_complexity protocol
        return TComplexity(clifford=4, rotations=2)
