...
from qualtran.bloqs.basic_gates import CNOT, Hadamard, Ry
from qualtran.bloqs.mcmt import And  # pylint: disable=unused-import
...
def test_end_to_end_summary_from_hwp_circuit_repr():
    ...
    circuit = eval(hwp_circuit_repr, {"cirq": cirq, "And": And})  # pylint: disable=eval-used
